...
@push('css')
    <link rel="stylesheet" href="{{ asset('administrator/vendors/gijgo/gijgo.min.css') }}" />
@endpush
@push('handlejs')
<script src="{{ asset('administrator/vendors/count_up/jquery.waypoints.min.js') }}"></script>

<script src="{{ asset('administrator/vendors/chartlist/Chart.min.js') }}"></script>

<script src="{{ asset('administrator/vendors/count_up/jquery.counterup.min.js') }}"></script>

<script src="{{ asset('administrator/vendors/swiper_slider/js/swiper.min.js') }}"></script>

<script src="{{ asset('administrator/vendors/niceselect/js/jquery.nice-select.min.js') }}"></script>

<script src="{{ asset('administrator/vendors/owl_carousel/js/owl.carousel.min.js') }}"></script>

<script src="{{ asset('administrator/vendors/gijgo/gijgo.min.js') }}"></script>

<script src="{{ asset('administrator/vendors/datatable/js/buttons.flash.min.js') }}"></script>
<script src="{{ asset('administrator/vendors/datatable/js/jszip.min.js') }}"></script>
<script src="{{ asset('administrator/vendors/datatable/js/pdfmake.min.js') }}"></script>
<script src="{{ asset('administrator/vendors/datatable/js/vfs_fonts.js') }}"></script>
<script src="{{ asset('administrator/vendors/datatable/js/buttons.html5.min.js') }}"></script>
<script src="{{ asset('administrator/vendors/datatable/js/buttons.print.min.js') }}"></script>

<script src="{{ asset('administrator/js/chart.min.js') }}"></script>

<script src="{{ asset('administrator/vendors/progressbar/jquery.barfiller.js') }}"></script>

<script src="{{ asset('administrator/vendors/tagsinput/tagsinput.js') }}"></script>

<script src="{{ asset('administrator/vendors/text_editor/summernote-bs4.js') }}"></script>
<script src="{{ asset('administrator/vendors/am_chart/amcharts.js') }}"></script>
<script src="{{ asset('administrator/vendors/apex_chart/apexcharts.js') }}"></script>
<script src="{{ asset('administrator/vendors/apex_chart/apex_realestate.js') }}"></script>

<script src="{{ asset('administrator/vendors/chart_am/core.js') }}"></script>
<script src="{{ asset('administrator/vendors/chart_am/charts.js') }}"></script>
<script src="{{ asset('administrator/vendors/chart_am/animated.js') }}"></script>
<script src="{{ asset('administrator/vendors/chart_am/kelly.js') }}"></script>
<script src="{{ asset('administrator/vendors/chart_am/chart-custom.js') }}"></script>

<script src="{{ asset('administrator/js/custom.js') }}"></script>
<script src="{{ asset('administrator/vendors/apex_chart/bar_active_1.js') }}"></script>
<script src="{{ asset('administrator/vendors/apex_chart/apex_chart_list.js') }}"></script>
    <script>
        $( document ).ready(function() {
            $('#sidebar_menu > li:nth-child(1)').addClass('mm-active');
        });
    </script>
@endpush
            ...
            <div class="col-lg-4">
                <div class="white_box QA_section card_height_100 blud_card">
                    ...
                    <div class="content_user">
                        ...
                        <img src="{{ asset('administrator/img/users_img.png') }}" alt>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
