        ...
        <div class="row justify-content-center">
            <div class="col-12 white_box_tittle">
                <div class="box_detail_content align-items-center">
                    <form class="form_edit_item row justify-content-center" action="{{route('admin.transaction.store_withdraw')}}" method="POST">
                        @csrf
                        <div class="row mb-3">
                            <label
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-xl-5 col-sm-9">
                                <div class="input-group common_date_picker">
                                    <input class="digits" name="account_number" type="text" data-language="en">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-xl-5 col-sm-9">
                                <div class="input-group common_date_picker">
                                    <input class="digits" name="account_name" type="text" data-language="en">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
