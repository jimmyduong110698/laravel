                            ...
                            <tbody>
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                $recharger = DB::table('user_info')->find($item->recharger_id);
                                            @endphp
                                            {{$recharger->nick_name}}
                                        </td>
                                        <td>{{$item->create_date}}</td>
                                        <td>
                                            <a href="{{route('admin.transaction.recharge_edit',['id'=>$item->id])}}" class="btn btn-outline-secondary">View more</a>
                                        </td>
                                    </tr>
                                @endforeach       
                            </tbody>
